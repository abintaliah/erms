...
| 18. Server filtering/sorting/paging | paged Holds and members APIs/UI | API/UI tests | Covered |
| 19. Mandatory mutation reasons | API reason gate/event context | API tests | Covered |
| 20. Direct-member list and Open action | Holds member endpoint/detail UI | UI tests | Covered |

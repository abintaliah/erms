...
SELECT set_config('app.actor_type','automated_process',true),
       set_config('app.actor_name','Database migration 015',true),
       set_config('app.event_source','migration',true),
       set_config('app.change_reason','Restore consistent built-in role terminology',true),
       set_config('app.event_metadata','{"migration":"015_restore_system_role_terminology"}',true);

ALTER TABLE roles RENAME COLUMN is_platform_role TO is_system;
...
VALUES ('015_restore_system_role_terminology')
